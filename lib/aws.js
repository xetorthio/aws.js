...
AWSClient.prototype.sign = function(endpoint, action, parameters, date) {
    ...
    canonicalized_query_string = canonicalized_query_string.replace(/!/g,"%21");
    canonicalized_query_string = canonicalized_query_string.replace(/'/g,"%27");
    canonicalized_query_string = canonicalized_query_string.replace(/\*/g,"%2A");
    canonicalized_query_string = canonicalized_query_string.replace(/\(/g,"%28");
    canonicalized_query_string = canonicalized_query_string.replace(/\)/g,"%29");
